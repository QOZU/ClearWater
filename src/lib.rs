...
#[derive(Debug)]
pub struct ClearWaterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ClearWaterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ClearWater processing");
    
    let mut processor = ClearWaterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ClearWaterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ClearWaterProcessor::new(false);
